...
public class PsiphonTunnel {
    ...
    public interface HostService extends HostLogger, HostLibraryLoader {
        ...
        default Object getVpnService() {return null;} // Object must be a VpnService (Android < 4 cannot reference this class name)
        default Object newVpnServiceBuilder() {return null;} // Object must be a VpnService.Builder (Android < 4 cannot reference this class name)
    ...
    public synchronized boolean startRouting() throws Exception {
        ...
        mHostService.loadLibrary("psitun2socks");
        return startVpn();
    }
    ...
    public void routeThroughTunnel() {
        ...
        String socksServerAddress = "127.0.0.1:" + mLocalSocksProxyPort.get();
    ...
    private class PsiphonProviderShim implements PsiphonProvider {
        ...
        @Override
        public String bindToDevice(long fileDescriptor) {
            try {
        ...
        try {
            ...
            try {
                ...
                while (aliases.hasMoreElements()) {
                    ...
                    String pemCert = new String(Base64.encode(cert.getEncoded(), Base64.NO_WRAP), StandardCharsets.UTF_8);
    ...
    private static class NetworkMonitor {
        ...
        private final AtomicReference<String> activeNetworkType;
        private final AtomicReference<String> activeNetworkDNSServers;
        private final HostLogger logger;
