...
public class FileDialog extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.myPath = findViewById(R.id.fdPath);
        this.myPrompt = findViewById(R.id.fdPrompt);
        ...
        findViewById(R.id.fdButtonCancel).setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
					FileDialog.this.setResult(FileDialog.MODE_CREATE, FileDialog.this.getIntent());
					FileDialog.this.finish();
				}
			});
        findViewById(R.id.fdButtonCreate).setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
