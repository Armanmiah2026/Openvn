package com.alinaj.dev.service.vpn.logger;
...
public class SkStatus
{
	...
	*/
    ...
    static void newLogItem(LogItem logItem) {
        ...
        if (service != null) {
            service.log_message(logItem.getString(service));
        }
	...
	*/
	...
	public static void logException(LogLevel ll, String context, Exception e) {
		...
		if (context != null)
			li = new LogItem(ll, String.format("%s: %s, %s", context, e.getMessage(), sw));
		else
			li = new LogItem(ll, String.format("Erro: %s, %s", e.getMessage(), sw));
