...
public class StatisticsGraphData
{
    ...
    private final StatisticsGraphData.DataTransferStats m_dataTransferStats;
    ...
    public class DataTransferStats
    {
        ...
        public  String byteCountNoDisplaySize(long bytes, boolean si)
        {
            int unit = si ? 1000 : 1024;
            DecimalFormat formater = new DecimalFormat("0.0");
            if (bytes < unit) return formater.format((double) bytes / (double) 1024);
