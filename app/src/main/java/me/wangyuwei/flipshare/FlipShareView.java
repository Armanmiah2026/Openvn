...
public class FlipShareView extends View {
    ...
    private final int mSeparateLineHeight = dip2px(0.4f);
    //background color area
    private final RectF mBgRect;
    //shareItem's width
    private final int mItemWidth = dip2px(140);
    //shareItem's height
    private final int mItemHeight = dip2px(50);
    //shareItem's left x position
    private int mItemLeft = dip2px(0);
    //shareItem's top y position
    private int mItemTop = dip2px(50);
    //item's corner
    private final int mCorner = dip2px(6);
    //triangle's height
    private final int mTriangleHeight = dip2px(4);
    //border's margin
    private final int mBorderMargin = dip2px(5);
    ...
    //shareItem lists
    private final List<ShareItem> mItemList = new ArrayList<>();
    private final List<RectF> mItemRectList = new ArrayList<>();
    ...
    public static class Builder {
        ...
        private final View mParentView;
        private final List<ShareItem> mShareItemList = new ArrayList<>();
