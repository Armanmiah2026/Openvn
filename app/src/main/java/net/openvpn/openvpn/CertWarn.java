...
abstract class CertWarn implements OnCancelListener, OnClickListener {
    ...
    private View inflateCertificateView(Context context, X509Certificate cert, String error) {
        ...
        ((TextView) certificateView.findViewById(R.id.to_common)).setText(subject.get("CN"));
        ((TextView) certificateView.findViewById(R.id.to_org)).setText(subject.get("O"));
        ((TextView) certificateView.findViewById(R.id.to_org_unit)).setText(subject.get("OU"));
        ((TextView) certificateView.findViewById(R.id.by_common)).setText(issuer.get("CN"));
        ((TextView) certificateView.findViewById(R.id.by_org)).setText(issuer.get("O"));
        ((TextView) certificateView.findViewById(R.id.by_org_unit)).setText(issuer.get("OU"));
