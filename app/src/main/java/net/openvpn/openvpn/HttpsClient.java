...
public class HttpsClient {
    ...
    public static class AdaptiveHostnameVerifier implements HostnameVerifier {
        private final HostnameVerifier bchv = new BrowserCompatHostnameVerifier();
    ...
    public static class AuthContext {
        ...
        public static class CR {
            private final String challenge_text;
            ...
            public CR(String cookie) throws ParseError {
                ...
                if (sl.length != 5) {
                    ...
                    this.state_id = sl[2];
                    this.username = new String(Base64.decode(sl[3], 0), StandardCharsets.UTF_8);
        ...
        public void cr_parse(String cookie) throws HttpsClient.AuthContext.CR.ParseError {
        ...
        public void set_basic_auth(URLConnection uc) throws UnsupportedEncodingException {
            uc.setRequestProperty("Authorization", "Basic " + Base64.encodeToString((get_username() + ":" + get_password()).getBytes(StandardCharsets.UTF_8), 2));
        }
    ...
    public static abstract class Task implements Runnable {
        ...
        protected static class ErrorDialogException extends Exception {
            private final int msg_resid;
            private final Object obj;
            private final int title_resid;
        ...
        protected HttpsURLConnection get_conn(AuthContext ac) throws IOException {
                            ...
                            if (!cancel.is_canceled()) {
                                try {
                                    ...
                                    if (response_required) {
                                        ...
                                        final EditText resp = view.findViewById(R.id.dialog_response);
