...
public class JellyBeanHack extends JellyBeanHackBase {
    ...
    public static JellyBeanHack newJellyBeanHack() {
        Log.i(TAG, String.format("Build.VERSION.SDK_INT=%d", Integer.valueOf(VERSION.SDK_INT)));
    ...
    private JellyBeanHack() {
        ...
        Log.i(TAG, String.format("JellyBeanHack: rsa_sign_initialized=%b", Boolean.valueOf(this.rsa_sign_initialized)));
    }
