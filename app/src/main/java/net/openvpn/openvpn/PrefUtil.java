...
public class PrefUtil {
    ...
    public String get_string(String key) {
        try {
            ...
            Log.d(TAG, String.format("get_string: %s='%s'", key, value));
            return value;
        } catch (ClassCastException e) {
            Log.d(TAG, String.format("get_string %s class cast exception", key));
            return null;
        }
    }
    ...
    public Set<String> get_string_set(String key) {
        try {
            ...
            Log.d(TAG, String.format("get_string_set: %s='%s'", key, value));
            return value;
        } catch (ClassCastException e) {
            Log.d(TAG, String.format("get_string_set %s class cast exception", key));
            return null;
        }
    }
    ...
    public boolean get_boolean(String key, boolean default_value) {
        try {
            ...
            Log.d(TAG, String.format("get_boolean: %s=%b", key, Boolean.valueOf(value)));
            return value;
        } catch (ClassCastException e) {
            Log.d(TAG, String.format("get_boolean %s class cast exception", key));
    ...
    public void set_string(String key, String value) {
        ...
        Log.d(TAG, String.format("set_string: %s='%s'", key, value));
        editor.apply();
    }
    ...
    public void set_boolean(String key, boolean value) {
        ...
        Log.d(TAG, String.format("set_boolean: %s=%b", key, Boolean.valueOf(value)));
        editor.apply();
    }
    ...
    public String get_string_by_profile(String profile_name, String key) {
        try {
            ...
            Log.d(TAG, String.format("get_string_by_profile: key='%s' value='%s'", key, value));
            return value;
        } catch (ClassCastException e) {
    ...
    public void set_string_by_profile(String profile_name, String key, String value) {
        ...
        Log.d(TAG, String.format("set_string_by_profile: key='%s' value='%s'", pkey, value));
    ...
    public boolean get_boolean_by_profile(String profile_name, String key, boolean default_value) {
        try {
            ...
            Log.d(TAG, String.format("get_boolean_by_profile: key='%s' value=%b", key, Boolean.valueOf(value)));
            return value;
        } catch (ClassCastException e) {
    ...
    public void set_boolean_by_profile(String profile_name, String key, boolean value) {
        Editor editor = this.mSettings.edit();
        String pkey = key_by_profile(profile_name, key);
        Log.d(TAG, String.format("set_boolean_by_profile: key='%s' value=%b", pkey, Boolean.valueOf(value)));
    ...
    public void delete_key(String key) {
        Editor editor = this.mSettings.edit();
        Log.d(TAG, String.format("delete_key: key='%s'", key));
        editor.remove(key);
        editor.apply();
    }
    ...
    public void delete_key_by_profile(String profile_name, String key) {
        Editor editor = this.mSettings.edit();
        String pkey = key_by_profile(profile_name, key);
        Log.d(TAG, String.format("delete_key_by_profile: key='%s'", pkey));
        editor.remove(pkey);
        editor.apply();
    }
