...
public class ovpncliJNI {
    ...
    public static boolean SwigDirector_ClientAPI_OpenVPNClient_tun_builder_set_layer(ClientAPI_OpenVPNClient self, int layer) {
        return self.tun_builder_set_layer(layer);
    }
    ...
    public static boolean SwigDirector_ClientAPI_OpenVPNClient_tun_builder_set_route_metric_default(ClientAPI_OpenVPNClient self, int metric) {
        return self.tun_builder_set_route_metric_default(metric);
    }
    ...
    public static boolean SwigDirector_ClientAPI_OpenVPNClient_tun_builder_add_route(ClientAPI_OpenVPNClient self, String address, int prefix_length, int metric, boolean ipv6) {
        return self.tun_builder_add_route(address, prefix_length, metric, ipv6);
    }

    public static boolean SwigDirector_ClientAPI_OpenVPNClient_tun_builder_exclude_route(ClientAPI_OpenVPNClient self, String address, int prefix_length, int metric, boolean ipv6) {
        return self.tun_builder_exclude_route(address, prefix_length, metric, ipv6);
    }
    ...
    public static boolean SwigDirector_ClientAPI_OpenVPNClient_tun_builder_set_adapter_domain_suffix(ClientAPI_OpenVPNClient self, String name) {
        return self.tun_builder_set_adapter_domain_suffix(name);
    }
    ...
    public static void SwigDirector_ClientAPI_OpenVPNClient_tun_builder_teardown(ClientAPI_OpenVPNClient self, boolean disconnect) {
        self.tun_builder_teardown(disconnect);
    }
    ...
    public static void SwigDirector_ClientAPI_OpenVPNClient_connect_attach(ClientAPI_OpenVPNClient self) {
        self.connect_attach();
    }

    public static void SwigDirector_ClientAPI_OpenVPNClient_connect_detach(ClientAPI_OpenVPNClient self) {
        self.connect_detach();
    }

    public static void SwigDirector_ClientAPI_OpenVPNClient_connect_pre_run(ClientAPI_OpenVPNClient self) {
        self.connect_pre_run();
    }

    public static void SwigDirector_ClientAPI_OpenVPNClient_connect_run(ClientAPI_OpenVPNClient self) {
        self.connect_run();
    }

    public static void SwigDirector_ClientAPI_OpenVPNClient_connect_session_stop(ClientAPI_OpenVPNClient self) {
        self.connect_session_stop();
    }
